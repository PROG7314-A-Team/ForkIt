...
class FoodLogsModelsTest {
    ...
    fun `daily calorie summary aggregates nutritional data`() {
        ...
        val mealDistribution = listOf(
            MealDistributionEntry("Breakfast", 400, 25),
            MealDistributionEntry("Lunch", 600, 37),
            MealDistributionEntry("Dinner", 500, 31),
            MealDistributionEntry("Snacks", 100, 7)
        )
    ...
    fun `meal totals sum all meal types`() {
        ...
        // Assert
        assertEquals(400, mealTotals.Breakfast)
        assertEquals(600, mealTotals.Lunch)
        assertEquals(500, mealTotals.Dinner)
        assertEquals(100, mealTotals.Snacks)
